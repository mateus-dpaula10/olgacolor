  ...
  blocks = [
    {
      ...
      productImg: 'assets/images/products_aglo.avif',
      altProduct: 'Imagem de produtos Aglo',
      isLeft: true,
      isLast: false
    },
    {
      imgSrc: 'assets/images/lock.avif',
      altImg: 'Logo da Lock',
      details: [
      ...
      productImg: 'assets/images/products_lock.avif',
      altProduct: 'Imagem de produtos Aglo',
      isLeft: false,
      isLast: false
    },
    {
      imgSrc: 'assets/images/grid.avif',
      altImg: 'Logo da Grid',
      details: [
      ...
      productImg: 'assets/images/products_grid.avif',
